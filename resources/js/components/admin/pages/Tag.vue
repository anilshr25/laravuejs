    ...
    export default {
        ...
        methods: {
            async addTag() {
                ...
                const res = await this.callApi('post', '/tag/add_category', this.data);
                if(res.status == 201) {
            ...
            async deleteTag() {
                ...
                const res = await this.callApi('post', '/tag/delete_tag', this.deleteData);
                if(res.status == 200) {
        ...
        async created() {
            const res = await this.callApi('get', '/tag/get_tag');
            if(res.status == 200) {
                this.tags = res.data;
            }else {
                this.swrong();
